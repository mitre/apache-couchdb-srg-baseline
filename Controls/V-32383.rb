...
in the case of an auditing failure.
  ...
  describe "This test requires a Manual Review: Review CouchDB logging application settings and/or documentation to
  determine whether the system is capable of shutting down, rolling back all
  in-flight transactions, in the case of an auditing failure. " do
    skip "This test requires a Manual Review: Review CouchDB logging application settings and/or documentation to
    determine whether the system is capable of shutting down, rolling back all
    in-flight transactions, in the case of an auditing failure. "
end
end
